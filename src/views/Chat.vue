<template>
  ...
  <div class="chat-container">
    ...
    <div class="chat-wrapper">
      ...
      <span
        ><i
          :class="[!barsToggle ? 'fal fa-bars' : 'fal fa-times']"
          @click="toggleUsers"
        ></i
      ></span>
      <div
        v-if="selectedUser"
        class="messege-area-wrapper"
      ...
      >
        ...
        <div v-if="currentUser" class="messeges-container">
          <div
            class="messege-wrapper"
            v-for="userMessege in usersMesseges"
            :key="userMessege.key"
          >
            <div
              class="messege"
              v-if="
                (userMessege.transmitter === currentUser &&
                  userMessege.receive === user_id) ||
                (userMessege.transmitter === user_id &&
                  userMessege.receive === currentUser)
              "
              :class="
                userMessege.transmitter === currentUser
                  ? 'current-user'
        ...
        <div class="input-text">
          <input
            v-on:keyup.enter="sendMessege()"
            v-model="messegeToSend"
            type="text"
            placeholder="Messege"
          />
          <span @click="sendMessege" class="send"
