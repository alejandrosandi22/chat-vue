        ...
        <form class="form" id="form" @submit.prevent="signup">
          ...
          <div class="line-two">
            ...
            <div class="photo-user input-wrapper">
              ...
              />
              <label class="label-input-file" for="photo_user"
          ...
          <div class="line-three">
            ...
            <div class="request-password input-wrapper">
              <input
                ...
                :class="{ emptyInput: requestPassword !== '' }"
                required
              />
        ...
        firebase
          ...
          .then(async (user_data) => {
            ...
            if (this.selectedUserPhoto != "") {
              await storageRef
                .child(`/photos/${user_data.user.uid}`)
                .put(this.selectedUserPhoto)
                .then(async () => {
                  await storageRef
                    .child(`/photos/${user_data.user.uid}`)
                    .getDownloadURL()
...
<style lang="scss" src="../styles/SignUp.scss"></style>
